...
describe('InputFormItem', () => {
    ...
    it('calls onChange handler when input value changes', () => {
        ...
        const inputElement = screen.getByLabelText('Password').closest('input');
        if (!inputElement) {
            return;
        }
        fireEvent.change(inputElement, { value: 'newpassword' });

        screen.debug();
        expect(inputElement).toHaveTextContent('newpassword');
